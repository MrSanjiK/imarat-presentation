...
const en: Dict = {
  ...
  chapters: [
    ...
    { id: "projects-info", title: "Projects Info" },
  ...
  projectsInfo: {
    label: "Projects Info",
    title: "Construction Portfolio Statistics",
    sub: "Detailed information on all projects — land area, construction volume and current status",
    projectCol: "Project name",
    landCol: "Land (ha)",
    totalCol: "Total area (m²)",
    blocksCol: "Blocks",
    startedCol: "Started",
    builtCol: "Built (m²)",
    haUnit: "ha",
    m2Unit: "m²",
    note: "Data as of August 2026",
  },
  contact: {
    label: "Contact",
    title: "Let's talk",
