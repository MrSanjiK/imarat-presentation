...
const uz: Dict = {
  ...
  chapters: [
    ...
    { id: "projects-info", title: "Loyihalar ma'lumoti" },
  ...
  projectsInfo: {
    label: "Loyihalar bo'yicha ma'lumot",
    title: "Qurilish portfeli statistikasi",
    sub: "Barcha loyihalar bo'yicha batafsil ma'lumotlar — yer maydoni, qurilish hajmi va joriy holat",
    projectCol: "Loyiha nomi",
    landCol: "Yer (ga)",
    totalCol: "Jami maydon (m²)",
    blocksCol: "Bloklar",
    startedCol: "Boshlangan",
    builtCol: "Qurilgan (m²)",
    haUnit: "ga",
    m2Unit: "m²",
    note: "Ma'lumotlar 2026-yil avgust holatiga ko'ra",
  },
  contact: {
    label: "Aloqa",
